...
function SubCategory() {
    ...
    useEffect(() => {
        const fetchCategoryDetails = async () => {
            try {
                const response = await axios.get(`http://localhost:5170/api/Category/subcategories/id=${id}`);
    ...
    const handleSubmitSub = async (e) => {
        ...
        try {
            const response = await axios.post('http://localhost:5170/api/Category', {
                name: name,
                parentId: parentId
            });
    ...
    const handleEditButtonClick = async (id) => {
        try {
            ...
            const response = await axios.get(`http://localhost:5170/api/Category/id=${id}`);
    ...
    const handleSaveChanges = async () => {
        ...
        try {
            await axios.put(`http://localhost:5170/api/Category/id=${selectedCategoryId}`, selectedCategory);
    ...
    const handleDeleteCategory = async (id) => {
        try {
            ...
            await axios.delete(`http://localhost:5170/api/Category/id=${id}`);
