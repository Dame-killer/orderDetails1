...
function Employee() {
    ...
    useEffect(() => {
        const fetchCustomers = async () => {
            try {
                const response = await axios.get('http://localhost:5170/api/Admin');
    ...
    useEffect(() => {
        ...
        fetch('http://localhost:5170/api/Role')
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await axios.post('http://localhost:5170/api/Admin', {
                username,
                password,
                email,
                fullName,
    ...
    const handleEditButtonClick = async (id) => {
        try {
            const response = await axios.get(`http://localhost:5170/api/Admin/id=${id}`);
    ...
    const handleSaveChanges = async () => {
        try {
            await axios.put(`http://localhost:5170/api/Admin/id=${selectedAdmin.Id}`, selectedAdmin);
            window.location.reload();
        } catch (error) {
    ...
    const handleDeleteCategory = async (id) => {
        try {
            ...
            await axios.delete(`http://localhost:5170/api/Admin/id=${id}`);
