...
function Order() {
  ...
  useEffect(() => {
    fetch("http://localhost:5170/api/Order")
                ...
                <div className="modal-body">
                  <div className="mb-3">
                    ...
                    <input
                      type="text"
                      className="form-control"
                      value={orderDetails ? orderDetails.BookName : ''}
                      id="name_em_edit1"
                      readOnly
                    />
                  </div>
                  <div className="mb-3">
                    ...
                    <input
                      type="text"
                      className="form-control"
                      placeholder={orderDetails?.Amount}
                      id="name_em_edit1"
                      readOnly
                    />
                  </div>
