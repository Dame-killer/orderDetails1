...
function Role() {
    ...
    useEffect(() => {
        const fetchRoles = async () => {
            try {
                const response = await axios.get('http://localhost:5170/api/Role');
    ...
    const handleSubmit = async (event) => {
        ...
        try {
            const response = await axios.post('http://localhost:5170/api/Role', {
                name: name
            });
    ...
    const handleEditButtonClick = async (id) => {
        try {
            const response = await axios.get(`http://localhost:5170/api/Role/id=${id}`);
    ...
    const handleSaveChanges = async () => {
        try {
            await axios.put(`http://localhost:5170/api/Role/id=${selectedRole.Id}`, selectedRole);
            window.location.reload();
        } catch (error) {
    ...
    const handleDeleteCategory = async (id) => {
        try {
            ...
            await axios.delete(`http://localhost:5170/api/Role/id=${id}`);
