...
function Payment() {
    ...
    useEffect(() => {
        fetch('http://localhost:5170/api/Payment')
    ...
    const handleSubmit = async () => {
        try {
            const response = await axios.post('http://localhost:5170/api/Payment', {
                name: name
            });
    ...
    const handleEditButtonClick = async (id) => {
        try {
            const response = await axios.get(`http://localhost:5170/api/Payment/id=${id}`);
    ...
    const handleSaveChanges = async () => {
        try {
            await axios.put(`http://localhost:5170/api/Payment/id=${selectedPayment.Id}`, selectedPayment);
    ...
    const handleDeleteCategory = async (id) => {
        try {
            ...
            await axios.delete(`http://localhost:5170/api/Payment/id=${id}`);
