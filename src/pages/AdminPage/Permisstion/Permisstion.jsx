...
function Permisstion() {
    ...
    const fetchPermisstions = async () => {
      try {
        const response = await axios.get(
          "http://localhost:5170/api/Permission"
        );
  ...
  const handleEditButtonClick = async (id) => {
    try {
      const response = await axios.get(
        `http://localhost:5170/api/Permission/id=${id}`
      );
  ...
  const handleSaveChanges = async () => {
    try {
      await axios.put(
        `http://localhost:5170/api/Permission/id=${selectedPermisstion.Id}`,
        selectedPermisstion
      );
      window.location.reload();
    } catch (error) {
  ...
  const handleDeleteCategory = async (id) => {
    try {
      ...
      await axios.delete(`http://localhost:5170/api/Permission/id=${id}`);
                          ...
                          <tr key={permisstion.Id}>
                            ...
                            <td>
                              ...
                              <button
                                ...
                                onClick={() =>
                                  handleDeleteCategory(permisstion.Id)
                                }
                              >
