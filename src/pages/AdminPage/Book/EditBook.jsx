...
function EditBook() {
  ...
  useEffect(() => {
    ...
    fetch("http://localhost:5170/api/Category/byParntId")
  ...
  useEffect(() => {
    const fetchBookDetails = async () => {
      try {
        const response = await fetch(`http://localhost:5170/api/Book/id=${id}`);
        if (response.ok) {
